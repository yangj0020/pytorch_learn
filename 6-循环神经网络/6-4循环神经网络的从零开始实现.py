# @Time: 2021/10/8 14:57
# @Author: yangj0020
# @File: 6-4循环神经网络的从零开始实现.py
# @Description:
...
6.4.2 初始化模型参数
"""
num_inputs, num_hiddens, num_outputs = vocab_size, 256, vocab_size  # num_hiddens是一个超参数
...
def get_params():
    ...
    # H_t = ϕ(X_t * W_xh + H_(t-1) * W_hh + b_h), O_t = H_t * W_hq + b_q
    # 隐藏层参数
